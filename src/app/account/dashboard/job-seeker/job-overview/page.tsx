...
export default function JobSeekerOverview() {
  ...
  return (
    <main className="bg-[#101110] min-h-screen text-white">
      <NavbarJobSeeker />
          ...
          <div className="bg-[#161716] p-[24px_20px_24px_20px] gap-[32px] rounded-[12px] border-solid border-[#1D1D1C] space-y-4">
            ...
            <div className="p-2 space-y-4">
              ...
              <ul className="list-none space-y-2 text-[#D9D9D9]">
                ...
                <li className="flex gap-2">
                  ...
                  <span>Develop and implement comprehensive quality assurance policies, procedures, and standards.</span>
                </li>
                <li className="flex gap-2">
                  <span className="min-w-[6px] h-[6px] rounded-full bg-[#D9D9D9] mt-2" />
                  <span>Oversee all aspects of the QA process, including planning, testing, and reporting.</span>
                </li>
                <li className="flex gap-2">
                  <span className="min-w-[6px] h-[6px] rounded-full bg-[#D9D9D9] mt-2" />
                  <span>Lead and mentor the QA team, fostering a culture of continuous improvement.</span>
                </li>
                <li className="flex gap-2">
                  <span className="min-w-[6px] h-[6px] rounded-full bg-[#D9D9D9] mt-2" />
                  <span>Collaborate with product development, engineering, and operations teams to identify and resolve quality issues.</span>
                </li>
                <li className="flex gap-2">
                  <span className="min-w-[6px] h-[6px] rounded-full bg-[#D9D9D9] mt-2" />
                  <span>Monitor key quality metrics and develop strategies to address gaps.</span>
                </li>
                <li className="flex gap-2">
                  <span className="min-w-[6px] h-[6px] rounded-full bg-[#D9D9D9] mt-2" />
                  <span>Conduct regular audits and reviews to ensure compliance with regulatory requirements and company standards.</span>
                </li>
                <li className="flex gap-2">
                  <span className="min-w-[6px] h-[6px] rounded-full bg-[#D9D9D9] mt-2" />
                  <span>Stay updated on industry trends and emerging technologies to enhance QA processes.</span>
                </li>
                <li className="flex gap-2">
                  <span className="min-w-[6px] h-[6px] rounded-full bg-[#D9D9D9] mt-2" />
                  <span>Manage resource allocation and prioritize tasks to meet project deadlines.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-2 space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#D9D9D9]">
                <li>Bachelor's degree in Quality Management, Engineering, or a related field.</li>
                <li>Proven experience as a Quality Assurance Manager or in a similar role.</li>
                <li>Strong knowledge of QA methodologies, tools, and processes.</li>
                <li>Experience with software development and testing frameworks is a plus.</li>
                ...
                <li>Detail-oriented with a commitment to achieving excellence.</li>
              </ul>
            </div>
        ...
        <div className="w-[400px] space-y-6 bg-[#161716] rounded-[8px] p-[20px] h-[638px]">
          <div className="space-y-4">
            ...
            <p className="text-[#D9D9D9] leading-[24px] text-[16px] font-[400]">
              SkillNet is an innovative, blockchain-powered platform that seamlessly connects job seekers with employers while empowering tutors and institutions to create, sell, and deliver high-quality courses and exams. It combines the best of both worlds—an online job marketplace and a learning hub—giving users a competitive edge in today's ever-evolving job market. Job seekers can enhance their skills through verified courses and exams, employers gain access to a pool of talented candidates, and tutors/institutions monetize their expertise—all powered by the StarkNet blockchain for security, transparency, and decentralization.
            </p>
          </div>
