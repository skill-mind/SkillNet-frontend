        ...
        <div className="w-[1240px] flex flex-col justify-center gap-6">
          ...
          <div className="w-[1240px] mx-auto pb-20 flex flex-wrap flex-col md:flex-row items-center justify-center gap-5">
            <div className="w-[326px] md:w-[398px] md:h-[220px] bg-[#101110] border-2 border-[#222220] p-16 pt-10 rounded-md">
              <h4 className="text-[18px] mb-5">1</h4>
              <p className="text-[14px]">
                Enable job seekers to enhance their skills and find personalized
                career opportunities
              </p>
            </div>
            <div className="w-[326px] md:w-[398px] md:h-[220px] bg-[#101110] border-2 border-[#222220] p-16 pt-10 rounded-md">
              <h4 className="text-[18px] mb-5">2</h4>
              <p className="text-[14px]">
                Enable job seekers to enhance their skills and find personalized
                career opportunities
              </p>
            ...
            <div className="w-[326px] md:w-[398px] md:h-[220px] bg-[#101110] border-2 border-[#222220] p-16 pt-10 rounded-md">
              <h4 className="text-[18px] mb-5">3</h4>
              <p className="text-[14px]">
                Facilitate secure, low-fee payments for courses, exams, and
                certifications through StarkNet blockchain.
              </p>
            </div>
            <div className="w-[326px] md:w-[398px] md:h-[280px] bg-[#101110] border-2 border-[#222220] p-16 pt-10 rounded-md">
              <h4 className="text-[18px] mb-5">4</h4>
              <p className="text-[14px]">
                Issue verifiable blockchain certificates and exam results upon
                completion for authenticity and trust.with employers, while
                offering a transparent, decentralized education and exam system,
                with certificates and exam results verified on the blockchain.
              </p>
            </div>
            <div className="w-[326px] md:w-[398px] md:h-[280px] bg-[#101110] border-2 border-[#222220] p-16 pt-10 rounded-md">
              <h4 className="text-[18px] mb-5">5</h4>
              <p className="text-[14px]">
                Empower tutors and institutions to create and monetize their
                courses and exams, helping students and employees gain new
