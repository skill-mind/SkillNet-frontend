  ...
  return (
    <div className="relative pt-[150px] md:pt-[200px] lg::pt-[252px] pb-[128px] text-center flex flex-col items-center px-6">
      ...
      <p className="text-sm md:text-base md:leading-[22px] text-[#D9D9D9] max-w-[750px]">
        Having any troubles? If our FAQ section didn&apos;t provide the solution
        you&apos;re looking for, please submit a support ticket. Our team is
        here to assist you and will respond within 48 business hours.
      </p>
