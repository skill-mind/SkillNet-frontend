...
function CreateExamModel() {
  ...
  const [candidateEligibility, setCandidateEligibility] = useState<string>("SC");
        ...
        <div className="md:flex w-full space-y-5 md:space-y-0 gap-4">
          <div className="flex flex-col w-full md:w-[60%] gap-[20px]">
            <div className="flex flex-col w-full">
              <label className="text-[#9596A0] text-[0.875rem] mb-1" htmlFor="examName">
                Exam Name*
              </label>
              <input
            ...
            <div className="w-full flex flex-col">
              <label className="text-[#9596A0] text-[0.875rem] mb-1" htmlFor="examDescription">
                Exam Description
              </label>
              <textarea
                id="examDescription"
            ...
            <div className="flex w-full flex-col items-stretch">
              <label className="text-[#9596A0] text-[0.875rem] mb-1" htmlFor="examType">
                Exam Type*
              </label>
              <select
              ...
              >
                <option className="bg-[#161716]" value="SC">Single choice</option>
                <option className="bg-[#161716]" value="MC">Multiple choice</option>
              </select>
            </div>
          </div>
          <div className="flex flex-col w-full gap-[24px] md:w-[40%]">
            <div className="flex w-full flex-col items-stretch">
              <label className="text-[#9596A0] text-[0.875rem] mb-1" htmlFor="candidateEligibility">
              ...
              >
                <option className="bg-[#161716]" value="SC">Paid Course</option>
                <option className="bg-[#161716]" value="MC">Free course</option>
              </select>
            </div>
            <div>
              <label className="text-[#9596A0] text-[0.875rem] mb-1" htmlFor="courseCategory">
                Course Category
              </label>
            ...
            <div className="flex w-full flex-col gap-[5px] items-stretch">
              <label className="text-[#9596A0] text-[0.875rem] mb-1" htmlFor="certification">
                Certification*
              </label>
              <select
                className="bg-transparent border-[1px] outline-none border-[#252625] text-white text-[0.875rem] w-full px-4 py-[0.40rem] rounded-[0.5rem]"
              ...
              >
                <option className="bg-[#161716]" value="Yes">Yes</option>
                <option className="bg-[#161716]" value="No">No</option>
              </select>
              {certification === "Yes" && (
            ...
            <div className="flex flex-col w-full items-stretch">
              <label className="text-[#9596A0] text-[0.875rem] mb-1" htmlFor="duration">
                Exam Duration*
              </label>
              <input
        ...
        {questions.length > 0 && (
          <div className="bg-[#161716] rounded-[8px] gap-[24px] p-[24px]">
            <h1 className="text-[#9596A0] text-[0.875rem] mb-7">
              {questions.length > 1 ? "Questions" : "Question"} {questions.length}
            </h1>
