        ...
        <div style={styles.content}>
          <div style={styles.examCard}>
            <h2 style={styles.examTitle}>
              WEB3 FUNDAMENTALS CERTIFICATION EXAM
            </h2>
            <p style={styles.examDescription}>
              The Web3 Test Exam is a blockchain-powered assessment designed to
              evaluate a candidate&apos;s understanding of decentralized
              technologies, smart contracts, and blockchain security. This exam
              is hosted on SkillNet, ensuring that all results are securely
              stored on-chain for authenticity and tamper-proof verification.
            </p>
