        ...
        {jobs.map((job) => (
          <div key={job.id} className="bg-[#161716] rounded-lg p-5">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start mb-2">
              <div>
                <h3 className="text-xl sm:text-[24px] text-white font-semibold">
                  {job.title}
                </h3>
              ...
              <div className="flex space-x-2 text-[#A8C789] mt-3 sm:mt-0">
                <button
                  ...
                  className="px-4 sm:px-6 py-2 bg-transparent border border-gray-600 rounded text-xs hover:bg-gray-700 transition"
                >
                  EDIT
                </button>
