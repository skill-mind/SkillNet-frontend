...
const Applications = () => {
  ...
  const [isResponsibilitiesExpanded, setIsResponsibilitiesExpanded] =
    useState(true);
          ...
          >
            ...
            <div className="p-4">
              <div className="text-xs text-[#606060] mb-1">
                Posted {applicant.postedTime}
              </div>
              <h2 className="text-white text-xl md:text-[24px] pt-3 font-semibold">
                {applicant.name}
              </h2>
            ...
            {expandedId === applicant.id && (
              <div className="p-4 gap-2 bg-[#161716] border-b border-[#1D1D1C]">
                <div className="mb-4">
                  <h3 className="text-[#76776] text-base md:text-[18px] mb-2">
                    Submission
                  </h3>
                  <p className="text-sm md:text-[16px] text-[#D9D9D9]">
                ...
                <div className="mb-4">
                  ...
                  <div className="space-y-4 py-4">
                    {applicant.certifications.map((cert, index) => (
                      <div
                        key={index}
                        className="p-4 rounded-md flex flex-col md:flex-row items-start md:items-center gap-4"
                      >
                        <div className="bg-[#D9D9D9] w-12 h-12 rounded-md"></div>
                        <div className="flex-grow">
                          <h4 className="text-white text-base md:text-[18px]">
                            {cert.title}
                          </h4>
                          <p className="text-[#999999] text-sm md:text-[14px]">
                            Provider: {cert.provider}
                          </p>
                          <p className="text-[#A8C789] text-xs cursor-pointer pt-2 underline">
                            {cert.id}
                          </p>
                        </div>
                        <div className="flex items-center justify-between w-full md:w-auto mt-2 md:mt-0">
                          <span className="text-[#BBBBBB] text-xs md:text-[14px] mr-2">
                            {cert.date}
                          </span>
                ...
                <div className="mb-4 border-b border-[#1D1D1C]">
                  <h3 className="text-[#767776] text-base md:text[18px] mb-4">
                    Skills
                  </h3>
        ...
        <div className="bg-[#161716] border-zinc-800 border rounded-md overflow-hidden">
          <div className="bg-[#161716] bg-opacity-10 p-3">
            <div className="flex items-center justify-between">
              <div className="font-medium mb-4 text-sm md:text-base">
                Job Title - (24 Applicants)
              </div>
            </div>
            <div className="text-xs text-[#606060] mb-1">
              Posted 12 hours ago
          ...
          <div className="px-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2 gap-3 mt-3">
              ...
              className="w-full sm:w-auto px-3 sm:px-[24px] py-2 sm:py-[10px] border border-zinc-700 rounded-md text-white text-xs md:text-[14px] hover:bg-zinc-800">
                EDIT OPENING
              </button>
            ...
            <div className="text-[#BBBBBB] text-xs md:text-[14px] mb-1">
              Job Type (e.g Hybrid)
            </div>

            <div className="flex flex-wrap gap-2 mb-6">
              <div className="bg-[#161716] bg-opacity-60 px-3 md:px-4 py-1 md:py-2 text-center rounded border border-zinc-700 text-[#BBBBBB] text-xs">
                Level
              </div>
              <div className="bg-[#161716] bg-opacity-60 px-3 md:px-4 py-1 md:py-2 text-center rounded border border-zinc-700 text-[#BBBBBB] text-xs">
                Deadline
            ...
            <div className="mb-4 mt-6">
              ...
              >
                <span className="text-[#76776] font-medium text-sm md:text-base">
                  Description
                </span>
                <ChevronDown
                  size={16}
              ...
              {isDescriptionExpanded && (
                <div className="py-3 text-xs md:text-sm text-[#D9D9D9] leading-relaxed">
                  ...
                  seamlessly connects job seekers with employers while
                  empowering tutors and institutions to create, sell, and
                  deliver high-quality courses and exams. It combines the best
                  of both worlds—an online job marketplace and a learning
                  hub—giving users a competitive edge in today&apos;s dynamic
                  job market.
                </div>
              )}
            </div>
            ...
            <div className="mb-4 border-b border-zinc-700">
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className={`transition-transform ${
                    isResponsibilitiesExpanded ? "transform rotate-180" : ""
                  }`}
                />
              </div>
