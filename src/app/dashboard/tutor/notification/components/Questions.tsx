   ...
   return (
      <>
         {questionsNotifications.map((questionsNotification, index) => (
            <div key={index} className="w-full mx-8 flex items-center justify-between   py-1 ">
               <div className="flex items-center justify-start gap-[31px]">
                  <div className=" w-[41px] h-[41px] rounded-full flex items-center justify-center overflow-hidden ">
                     <Image src={questionsNotification.image} alt="students" height={100} width={100} className="w-[41px] h-[41px] object-contain " />
                  </div>
                  ...
                  <div className="flex flex-col gap-3 ">
                     <h4 className="text-[#6E6E6E] text-base font-medium flex items-center">
                        ...
                        <span className="text-[#3D5682]"> {questionsNotification.category} </span>
                     </h4>

                     <p className="text-[#CCCCCC] text-base font-medium ">{questionsNotification.content} </p>
                  </div>
               </div>
               <Link href={"/dashboard/tutor/question"}>
