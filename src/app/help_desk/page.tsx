...
export default function page() {
  return (
    <div
      className={` w-full ${WorkSans.className} h-full font-light space-y-24 text-[#020402] text-[16px]pt-5 pb-10 bg-[#FCFCFC]`}>
      <Header />
      <Main />
    </div>
  );
...
export function Header() {
  return (
    <div className="flex pt-10 justify-center">
      <div className=" space-y-3 w-full md: lg:w-[871px] flex flex-col justify-center items-center">
        ...
        <p className="text-center  leading-5">
          ...
          support ticket. <br /> Our team is here to assist you and will respond within
          48 business hours.
        </p>
        <button
          type="button"
          className="py-2 md:py-4 px-4 md:px-8 font-medium hover:bg-[#bfef8e] rounded-full outline-none bg-[#D0EFB1]">
          Submit a Ticket
        </button>
      </div>
    </div>
...
export function Main() {
  return (
    <div className="space-y-4">
      <h1
        className={`lg:text-[32px] text-[24px] ${RaLeway.className}  font-bold text-center`}>
